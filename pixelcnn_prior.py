...
def main(args):
    ...
    save_filename = f'./models/{args.output_folder}/prior.pt'
    ...
    prior = GatedPixelCNN(input_dim=args.k, 
                          dim=args.hidden_size_prior, 
                          n_layers=args.num_layers, n_classes=10).to(args.device)
...
def arguments():
    ...
    # Latent space
    parser.add_argument('--hidden-size-vae', type=int, default=16, help='size of the latent vectors (default: 16)')
    parser.add_argument('--hidden-size-prior', type=int, default=16, help='hidden size for the PixelCNN prior (default: 16)')
    parser.add_argument('--k', type=int, default=512, help='number of latent vectors (default: 512)')
    parser.add_argument('--num-layers', type=int, default=15, help='number of layers for the PixelCNN prior (default: 15)')

    # Optimization
    parser.add_argument('--batch-size', type=int, default=128, help='batch size (default: 128)')
    parser.add_argument('--num-epochs', type=int, default=100, help='number of epochs (default: 100)')
    parser.add_argument('--lr', type=float, default=3e-4, help='learning rate for Adam optimizer (default: 3e-4)')

    # Miscellaneous
    parser.add_argument('--output-folder', type=str, default='prior', help='name of the output folder (default: prior)')
    parser.add_argument('--num-workers', type=int, default=2, help='number of workers for trajectories sampling (default: {0})'.format(mp.cpu_count() - 1))
